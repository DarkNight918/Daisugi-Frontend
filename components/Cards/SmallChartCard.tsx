...
const SmallChartCard: FC<SmallChartCardProps> = ({ header, height, value, change, chartData }) => {
  return (
    <div
              ...
              datasets: [
                {
                  ...
                  borderWidth: 1,
                  pointRadius: 0,
                  borderColor: change !== undefined ? (change > 0 ? "#28FF98" : "#db4737") : "#db4737",
                  backgroundColor: change !== undefined ? (change > 0 ? "#28FF9822" : "#db473722") : "#db473722",
                },
              ]
            }}
          />
