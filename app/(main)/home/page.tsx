...
const Home: FC = () => {
  ...
  const [gainers, setGainers] = useState<gainerType[]>();
  const [losers, setLosers] = useState<gainerType[]>();
  ...
  return (
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 2xl:grid-cols-3">
        ...
        <div className="bg-gradient-card1 h-[350px] rounded-lg p-5">
          ...
          {
            gainers && gainers.map((item: any, index: any) => (
        ...
        <div className="bg-gradient-card1 h-[350px] rounded-lg p-5">
          ...
          {
            losers && losers.map((item: any, index: any) => (
